...
[![Build Linux](https://github.com/pcastone/rivers/actions/workflows/build-linux.yml/badge.svg)](https://github.com/pcastone/rivers/actions/workflows/build-linux.yml)
[![Build macOS](https://github.com/pcastone/rivers/actions/workflows/build-macos.yml/badge.svg)](https://github.com/pcastone/rivers/actions/workflows/build-macos.yml)
[![Build Windows](https://github.com/pcastone/rivers/actions/workflows/build-windows.yml/badge.svg)](https://github.com/pcastone/rivers/actions/workflows/build-windows.yml)
...
Pre-built binaries are available on the [Releases](https://github.com/pcastone/rivers/releases/latest) page.
...
```bash
git clone https://github.com/pcastone/rivers.git && cd rivers
cargo build --release
```
